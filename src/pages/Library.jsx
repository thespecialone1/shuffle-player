  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 pb-24">
      ...
      <div className="flex flex-col">
        ...
        <div className="grid grid-cols-[auto_1fr_auto_auto] sm:grid-cols-[auto_1fr_1fr_1fr_auto] gap-4 items-center px-4 py-2 text-xs font-semibold text-[var(--color-text-tertiary)] uppercase tracking-wider border-b border-[var(--color-border-subtle)] mb-2">
            ...
            >
              ...
              <div className="flex items-center gap-4 min-w-0 pr-4">
                ...
                <div className="flex flex-col min-w-0">
                  ...
                  <span className="text-[13px] text-[var(--color-text-secondary)] text-ellipsis-1 sm:hidden">
                    <Link to={`/search?q=${encodeURIComponent(track.artist)}`} onClick={e => e.stopPropagation()} className="hover:underline hover:text-white transition-colors">{track.artist}</Link>
                  </span>
                </div>
              </div>
              ...
              <div className="hidden sm:block min-w-0 pr-4">
                <Link 
                  ...
                  className="text-[14px] text-[var(--color-text-secondary)] hover:text-white hover:underline transition-colors text-ellipsis-1 block"
                >
                  {track.artist}
                </Link>
              </div>
              ...
              <div className="hidden sm:block min-w-0 pr-4">
                <Link 
                  to={`/search?q=${encodeURIComponent(track.album)}`} 
                  onClick={e => e.stopPropagation()}
                  className="text-[14px] text-[var(--color-text-secondary)] hover:text-white hover:underline transition-colors text-ellipsis-1 block"
                >
                  {track.album}
              ...
              <div className="flex items-center justify-end gap-4 min-w-[80px] w-20">
                <button 
                ...
                <div className="text-sm text-[var(--color-text-secondary)] text-right font-mono tracking-variant-numeric w-10">
